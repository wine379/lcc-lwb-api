...
const driver = _neo4jDriver.default.driver(process.env.NEO4J_URI || 'bolt://67.205.136.132:7687', _neo4jDriver.default.auth.basic(process.env.NEO4J_USER || 'neo4j', process.env.NEO4J_PASSWORD || 'letmein'), {
